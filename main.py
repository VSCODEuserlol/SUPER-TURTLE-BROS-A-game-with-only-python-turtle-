#Version 1.0.0, . All rights reserved for Birdicodes™ Corp. No part of this game may be [re]used without the author's permission. ®2025  
import turtle as t
import random
import math
import time
